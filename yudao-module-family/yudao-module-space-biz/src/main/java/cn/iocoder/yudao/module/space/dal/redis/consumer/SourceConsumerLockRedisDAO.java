...
import static cn.iocoder.yudao.module.space.dal.redis.RedisKeyConstants.SOURCE_CONSUMER_LOCK;
 ...
 */
@Repository
public class SourceConsumerLockRedisDAO {
    ...
    private static String formatKey(String messageNo) {
        return String.format(SOURCE_CONSUMER_LOCK, messageNo);
    }
